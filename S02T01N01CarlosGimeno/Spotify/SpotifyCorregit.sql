...
-- -----------------------------------------------------
-- Table `Spotify`.`canço_favorits`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Spotify`.`canço_favorits` (
  `idcanço_favorits` INT NOT NULL,
  `usuari_idusuari` INT NOT NULL,
  `cançó_idcançó` INT NOT NULL,
  PRIMARY KEY (`idcanço_favorits`),
  INDEX `fk_canço_favorits_usuari1_idx` (`usuari_idusuari` ASC) VISIBLE,
  INDEX `fk_canço_favorits_cançó1_idx` (`cançó_idcançó` ASC) VISIBLE,
  CONSTRAINT `fk_canço_favorits_usuari1`
    FOREIGN KEY (`usuari_idusuari`)
    REFERENCES `Spotify`.`usuari` (`idusuari`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_canço_favorits_cançó1`
